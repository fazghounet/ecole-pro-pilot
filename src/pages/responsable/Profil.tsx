...
const ResponsableProfil = () => {
  return (
    <DashboardLayout userRole="responsable" userName="Marie Dubois">
              ...
              <div className="grid gap-4">
                ...
                <div className="grid gap-2">
                  ...
                  <div className="flex">
                    ...
                    <Input id="email" type="email" defaultValue="marie.dubois@autoecole.fr" />
                  </div>
                </div>
                <div className="grid gap-2">
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              ...
              <div className="grid gap-2">
                ...
                <Input id="poste" defaultValue="Responsable pédagogique" readOnly />
              </div>
              <div className="grid gap-2">
              ...
              <div className="grid gap-2">
                ...
                <div className="flex">
                  ...
                  <Input id="dateembauche" defaultValue="15/03/2020" readOnly />
                </div>
              </div>
            </CardContent>
          </Card>
